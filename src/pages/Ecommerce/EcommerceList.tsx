import { Search, Plus, Filter, Download, ShoppingBag } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">E-Ticaret & Pazaryeri</h1>
          <p className="text-[#94a3b8] text-sm mt-1">Pazaryeri entegrasyonları ve sipariş senkronizasyonu.</p>
        </div>
