import { Search, Plus, Filter, Download, FileSignature } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Sözleşme Yönetimi</h1>
          <p className="text-[#94a3b8] text-sm mt-1">Müşteri ve tedarikçi sözleşmeleri, bitiş uyarıları.</p>
        </div>
      ...
      <div className="bg-[#141414] border border-[#27272a] rounded-xl flex flex-col items-center justify-center p-12 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#1c1c1f] flex items-center justify-center mb-4 border border-[#27272a]">
          <FileSignature size={32} className="text-[#52525b]" />
        </div>
