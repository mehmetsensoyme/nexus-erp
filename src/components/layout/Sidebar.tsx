...
export default function Sidebar() {
  const { isSidebarOpen, toggleSidebar, activeModules, favoriteModules, moduleSortPreference, moduleUsageStats, trackModuleUsage } = useUIStore();
    ...
    <>
      ...
      <aside className={cn(
        ...
        {isSidebarOpen ? (
          ...
          <button onClick={toggleSidebar} className="text-[#52525b] hover:text-white transition-colors shrink-0 p-1.5 rounded-md hover:bg-[#27272a] mx-auto flex items-center justify-center">
            <Menu size={18} />
          </button>
        )}
      </div>
